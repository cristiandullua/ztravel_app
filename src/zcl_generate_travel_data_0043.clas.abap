CLASS zcl_generate_travel_data_0043 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_0043 IMPLEMENTATION.
...
*   delete existing entries in the database table
    ...
    DELETE FROM ztravel_0043.

*   insert the new table entries
    INSERT ztravel_0043 FROM TABLE @itab.
